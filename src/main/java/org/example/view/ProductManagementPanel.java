...
public class ProductManagementPanel extends JPanel {
    ...
    public ProductManagementPanel() {
        ...
        // ===== PHÂN QUYỀN: CHỈ ADMIN MỚI THẤY THÊM / SỬA / XÓA =====
    ...
    private void openAddDialog() {
        ...
        btnSave.addActionListener(e -> {
            try {
                ...
                if (name.isEmpty()) {
                    JOptionPane.showMessageDialog(dialog, "Tên sản phẩm không được để trống!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                if (price <= 0) {
                ...
                productController.createProduct(name, price, active);
    ...
    private void openEditDialog() {
        ...
        boolean isActive    = "Đang bán".equals(tableModel.getValueAt(selectedRow, 3));
